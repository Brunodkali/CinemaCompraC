...
void imprimir(nome, FP, nome_filme) {
    int cf;
    ...
    switch (cf) {
        case 1:
            gerar(nome, nome_filme, quant_bilhetes, horario_sessao);
            break;
        case 2:
            menu();
            break;
...
void gerar(nome, nome_filme, quant_bilhetes, horario_sessao) {
    system("cls");
    printf("|-------------------------------------->>\n");
